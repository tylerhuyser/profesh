...
export default function SearchBar(props) {
  ...
  return (
    <div className={activePage == "home" ? 'search-bar-container hidden' : 'search-bar-container scale-in-ver-top'}>
      ...
      <input className='search-bar-input' name="search-bar-input" value={searchQuery} placeholder={activePage == "jobs tracker" ? 'Search Saved Opportunities (company, job title, location, etc.)' : 'Find New Jobs (by company, job title, location, etc.)' } onChange={(e) => setSearchQuery(e.target.value)} />
